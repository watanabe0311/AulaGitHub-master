...
public class TesteCalculadoraOO {
    ...
    public static void main(String[] args) {
        ...
        int operando1 = Integer.parseInt(JOptionPane.
        showInputDialog("Qual o primeiro operando?"));

        int operando2 = Integer.parseInt(JOptionPane.
        showInputDialog("Qual o segundo operando?"));
        int resultado;
